...
- (IBAction)shixiBtn:(id)sender {
    [self.shixi setImage:[UIImage imageNamed:@"xuanzhong@2x.png"] forState:UIControlStateNormal];
    [self.jiuye setImage:[UIImage imageNamed:@"checkbox@2x.png"] forState:UIControlStateNormal];
    advisoryType = 0;
...
- (IBAction)jiuyeBtn:(id)sender {
    [self.jiuye setImage:[UIImage imageNamed:@"xuanzhong@2x.png"] forState:UIControlStateNormal];
    [self.shixi setImage:[UIImage imageNamed:@"checkbox@2x.png"] forState:UIControlStateNormal];
    advisoryType = 1;
