...
-(NSString *)tianqitupian:(CLLocation *)location
{
    ...
    NSString *str;
    if (resDict) {
        NSDictionary *dict = [[NSDictionary alloc] initWithObjectsAndKeys:@"0",@"晴",@"1",@"中雪",@"2",@"中雨",@"3",@"阵雨",@"4",@"多云",@"5",@"多云转晴",@"6",@"小雪",@"7",@"阴转晴",@"8",@"阴",@"9",@"小雨",@"10",@"大雨",@"11",@"大雨转晴",@"12",@"多云转阴",@"13",@"雨加雪",@"14",@"小雨转晴",@"15",@"大学转晴",@"16",@"霾",@"17",@"中雨转晴",@"18",@"多云转晴天",@"19",@"暴雨转晴",@"20",@"中雨转阴",@"21",@"小雨转阴",@"22",@"大雨转阴",@"23",@"阵雨转阴", nil];
        NSDictionary *result = [resDict objectForKey:@"weatherinfo"];
